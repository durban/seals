...
class EnumLikeSpec extends BaseSpec {
  ...
  "EnumLike for Java enums" - {
    ...
    "MyTestEnum" in {
      ...
      inst.typeName should === ("dev.tauri.seals.tests.MyTestEnum")
      ...
      inst.fromIndexOpt(-1) should === (None)
      inst.fromNameError("xyz") should === ("'xyz' is not a(n) dev.tauri.seals.tests.MyTestEnum value")
      inst.fromIndexError(-1) should === ("-1 is not a(n) dev.tauri.seals.tests.MyTestEnum value")
    }

    "MyTestEnumWithArgs" in {
      val inst = EnumLike[MyTestEnumWithArgs]
      inst.typeName should === ("dev.tauri.seals.tests.MyTestEnumWithArgs")
      ...
      inst.fromIndexOpt(-1) should === (None)
      inst.fromNameError("xyz") should === ("'xyz' is not a(n) dev.tauri.seals.tests.MyTestEnumWithArgs value")
      inst.fromIndexError(-1) should === ("-1 is not a(n) dev.tauri.seals.tests.MyTestEnumWithArgs value")
    }

    "MyTestEnumWithOverloads" in {
      val inst = EnumLike[MyTestEnumWithOverloads]
      inst.typeName should === ("dev.tauri.seals.tests.MyTestEnumWithOverloads")
      ...
      inst.fromIndexOpt(2) should === (None)
      inst.fromIndexOpt(-1) should === (None)
      inst.fromNameError("xyz") should === ("'xyz' is not a(n) dev.tauri.seals.tests.MyTestEnumWithOverloads value")
      inst.fromIndexError(-1) should === ("-1 is not a(n) dev.tauri.seals.tests.MyTestEnumWithOverloads value")
    }

    "MyTestEnumWithToString" in {
      val inst = EnumLike[MyTestEnumWithToString]
      inst.typeName should === ("dev.tauri.seals.tests.MyTestEnumWithToString")
      ...
      inst.fromNameError("xyz") should === ("'xyz' is not a(n) dev.tauri.seals.tests.MyTestEnumWithToString value")
      inst.fromIndexError(-1) should === ("-1 is not a(n) dev.tauri.seals.tests.MyTestEnumWithToString value")
    }
  }
